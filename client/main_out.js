(function(h, f) {
    function Sa() {
        la = !0;
        updateRegions();
        setInterval(updateRegions, 10000);
        ...
        h.onresize = Da;
        Da();
        h.requestAnimationFrame ? h.requestAnimationFrame(Ea) : setInterval(oa, 1E3 / 60);
        setInterval(K, 40);
        v && f("#region").val(v);
        Fa();
        V(f("#region").val());
    ...
    function Ta() {
        if (.4 > g) L = null;
            ...
            for (l = 0; l < u.length; l++)
                if (k = u[l], k.I() && !(20 >= k.size * g))
                    for (a = 0; a < k.a.length; ++a) b = k.a[a].x, c = k.a[a].y, b < s - p / 2 / g || c < t - q / 2 / g || b > s + p / 2 / g || c > t + q / 2 / g || L.i(k.a[a])
        }
    }
    ...
    function updateRegions() {
        null == Z && (Z = {}, f("#region").children().each(function() {
            var a = f(this),
                b = a.val();
            b && (Z[b] = a.text())
        }));
        f.get($ + "/info", function(a) {
            var b = {}, c;
            for (c in a.regions) {
                var d = c.split(":")[0];
                b[d] = b[d] || 0;
    ...
    function W() {
        la && v && (f("#connecting").show(), getWsIp())
    }
    ...
    function Ha(a) {
        ...
        Va && (a = a.split(":"), a = a[0] + "s://ip-" + a[1].replace(/\./g, "-").replace(/\//g, "") + ".tech.agar.io:" + (+a[2] + 2E3));
        F = [];
        m = [];
        z = {};
        u = [];
    ...
    function Za(a) {
        ...
        switch (a.getUint8(c++)) {
            ...
            case 50:
                ...
                break;
            case 64:
                da = a.getFloat64(c, !0), c += 8, ea = a.getFloat64(c, !0), c += 8, fa = a.getFloat64(c, !0), c += 8, ga = a.getFloat64(c, !0), c += 8, P = (fa + da) / 2, Q = (ga + ea) / 2, R = 1, 0 == m.length && (s = P, t = Q, g = R)
        }
    }
    ...
    function $a(a, b) {
        ...
        for (e = 0;;) {
            ...
            n.L = G;
            n.W = f;
            q && n.Z(q); - 1 != F.indexOf(d) && -1 == m.indexOf(n) && (document.getElementById("overlays").style.display = "none", m.push(n), 1 == m.length && (s = n.x, t = n.y))
        }
        c = a.getUint32(b, !0);
        b += 4;
        for (e = 0; e < c; e++) d = a.getUint32(b, !0), b += 4, n = z[d], null != n && n.S();
        ta && 0 == m.length && Ca(!1)
    }
    ...
    function oa() {
        ...
        if (0 < m.length) {
            ...
            a += m[d].x / m.length, c += m[d].y / m.length;
            P = a;
            Q = c;
            R = g;
            s = (s + a) / 2;
            t = (t + c) / 2
        } else s = (29 * s + P) / 30, t = (29 * t + Q) / 30, g = (9 * g + R * Na()) / 10;
        Ta();
        na();
        va || e.clearRect(0, 0, p, q);
        va ? (e.fillStyle = ha ? "#111111" : "#F2FBFF", e.globalAlpha = .05, e.fillRect(0, 0, p, q), e.globalAlpha = 1) : cb();
        u.sort(function(a, b) {
        ...
        I = Math.max(I, db());
        0 != I && (null == ia && (ia = new ja(24, "#FFFFFF")), ia.u("Score: " + ~~(I / 100)), c = ia.G(), a = c.width, e.globalAlpha = .2, e.fillStyle = "#000000", e.fillRect(10, q - 10 - 24 - 10, a + 10, 34), e.globalAlpha = 1, e.drawImage(c, 15, q - 10 - 24 - 5));
        eb();
        b = Date.now() - b;
        b > 1E3 / 60 ? y -= .01 : b < 1E3 /
            65 && (y += .01);.4 > y && (y = .4);
    ...
    function cb() {
        ...
        e.globalAlpha = .2;
        e.scale(g, g);
        for (var a = p / g, b = q / g, c = -.5 + (-s + a / 2) % 50; c < a; c += 50) e.beginPath(), e.moveTo(c, 0), e.lineTo(c, b), e.stroke();
    ...
    function Ja() {
        ...
        if (null != x || 0 != A.length)
            if (null != x || ka) {
                ...
                if (null == x)
                    for (a.font = "20px Ubuntu", b = 0; b < A.length; ++b) c = A[b].name || "An unnamed cell",
                ka || (c = "An unnamed cell"), -1 != F.indexOf(A[b].id) ? (m[0].name && (c = m[0].name), a.fillStyle = "#FFAAAA") : a.fillStyle = "#FFFFFF", c = b + 1 + ". " + c, a.fillText(c, 100 - a.measureText(c).width / 2, 70 + 24 * b);
                else
    ...
    if ("undefined" == typeof console || "undefined" == typeof DataView || "undefined" == typeof WebSocket || null == Ra || null == Ra.getContext || null == h.localStorage) alert("You browser does not support this game, we recommend you to use Firefox to play this");
        ...
        f.get($ + "//gc.agar.io", function(a) {
            var b = a.split(" ");
            a = b[0];
            b = b[1] || ""; - 1 == "DE IL PL HU BR AT UA".split(" ").indexOf(a) && ya.push("nazi"); - 1 == ["UA"].indexOf(a) && ya.push("ussr");
        ...
        Ka.prototype = {
            ...
            Z: function(a) {
                if (this.name = a) null == this.k ? this.k = new ja(this.h(), "#FFFFFF", !0, "#000000") : this.k.H(this.h()), this.k.u(this.name)
            },
            R: function() {
            ...
            ha: function() {
                ...
                for (var k = this, h = this.d ? 0 : (this.id / 1E3 + G / 1E4) % (2 * Math.PI), d = 0; d < c; ++d) {
                    var f = a[d].e,
                        e = a[(d - 1 + c) % c].e,
                        l = a[(d + 1) % c].e;
            ...
            T: function() {
                if (this.I()) {
                    var a = !this.d && !this.j && .4 > g;
                    5 > this.C() && (a = !0);
                    if (this.M && !a)
                        for (var b = 0; b < this.a.length; b++) this.a[b].e = this.size;
                    this.M = a;
                    e.save();
                    this.ba = G;
                    b = this.K();
